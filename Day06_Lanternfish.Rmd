...
# at each step, we need to (in "parallel", not "serially")
# (a) for any fish at level 0: add same number for next step at level 6 and 8
# (b) shift each level down one to signify a day has passed (not including a)
